 ...
 * [mgpo.yml](mgpo.yml)
     * Determines how your purl.obolibrary.org/obo/mgpo/ redirects will be handled
     ...
     * Paste in the contents of [mgpo.yml](mgpo.yml)
 ...
 * [mgpo.md](mgpo.md)
     ...
     * Paste in the contents of [mgpo.md](mgpo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
